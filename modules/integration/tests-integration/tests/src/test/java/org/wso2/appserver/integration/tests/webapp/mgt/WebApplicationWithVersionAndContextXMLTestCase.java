...
public class WebApplicationWithVersionAndContextXMLTestCase extends ASIntegrationTest {
    ...
    private String webAppName = "context-reload-test-webapp/2";
    private String webAppFileName = "context-reload-test-webapp#2.war";
    ...
    public void testDeploymentOfVersionedWebappWithContextXML() throws Exception {
        ...
        WebAppDeploymentUtil.deployWebApplication(backendURL, sessionCookie, URLEncoder.encode(webAppFilePath,"UTF-8"));
